...
function scur_referral_published_post_list_only_shortcode($atts) {
    ...
    if (empty($results)) {
        return "<p class='scur_no_post_history_found'>No custom post history found!</p>";
    }
...
add_shortcode('referral_published_post_list_only', 'scur_referral_published_post_list_only_shortcode');
?>